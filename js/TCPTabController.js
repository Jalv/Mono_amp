...
monoApp.controller("TCPTabController",['$rootScope', '$scope', '$http',
...
this.getColumns = function(){
  ...
  {"data": "id_conversation_tcp", "name": "ID conv", "width":"3%"},
  {"data": "ip_a", "name": "IP A"},
...
this.addSelectCallback(self.getSelectCallbackConversation("id_conversation_tcp"));
this.addDoubleClickCallback(self.getDoubleClickCallbackConv("id_conversation_tcp"));
this.init("CONV_TCP");

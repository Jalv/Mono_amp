...
monoApp.controller("MITMConvsTabController",['$rootScope', '$scope', '$http',
...
this.getColumns = function(){
  ...
  {"data": "id_conversation_mitm", "name": "ID conv", "width":"3%"},
  {"data": "ip_a", "name": "IP A"},
...
this.addSelectCallback(self.getSelectCallbackConversation("id_conversation_mitm"));
this.addDoubleClickCallback(self.getDoubleClickCallbackConv("id_conversation_mitm"));
this.init("CONV_MITM");
